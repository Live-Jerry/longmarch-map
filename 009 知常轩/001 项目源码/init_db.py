...
MODULES = [
    ...
    ('西学中用', 'xixue', '#56004F', '#F5F0E8', '贯通中西，以他山之石攻玉——关注欧美各学科经典理论及书籍。', 9, '西'),
    ('编程世界', 'biancheng', '#16537E', '#F5F0E8', '关注编程学习和当前编程领域资讯，让编程思维成为新读写能力。', 10, '编'),
    ('英语学习', 'yingyu', '#DB5A6B', '#F5F0E8', '语言是打开世界的钥匙，循序渐进学英语。', 11, '英'),
    ('我的世界', 'wodeshijie', '#CA6924', '#F5F0E8', '开放话题广场，提供各年龄段孩子感兴趣的话题。', 12, '我'),
]
